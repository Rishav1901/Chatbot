...
notification.notify(
        title="flux ",
        message="flux initialized. Ready to go !",
        timeout=10,
        app_icon = "Customization\\flux.ico"
        )
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'quit' in a or 'close' in a or 'exit' in a or 'quit flux' in a or 'close flux' in a or 'exit flux' in a or 'bye' in a or 'bye flux' in a:
            speak("Thank you Sir for your time. Have a nice day.")
            break

        elif 'hello' in a or 'hello flux' in a or 'hi flux' in a or 'hi' in a or 'hey flux' in a or 'hey' in a:
            speak("Hello Sir. How are you ?")

        elif 'good morning' in a or 'good morning flux' in a:
            speak("Good Morning Sir !")

        elif 'good evening' in a or 'good evening flux' in a:
            speak("Good Evening Sir !")

        elif 'good night' in a or 'good night flux' in a:
            speak("Good Night Sir !")

        elif 'open cmd' in a or 'open command prompt' in a or 'open cmd flux' in a or 'open command prompt flux' in a:
            speak("Opening command prompt")
            os.startfile("C:\\WINDOWS\\system32\\cmd.exe")
        
        elif 'how are you' in a or 'how do you do' in a or 'how are you flux' in a or 'how do you do flux' in a:
            speak("I am fine Sir. Thank you for asking.")

        elif 'what is your name' in a or 'who are you' in a:
            speak("My name is flux - The virtual assistant cum chatbot. I was created by - Team show stopper  on 17th of january on 2022.")

        elif 'wait' in a or 'wait flux' in a or 'wait flux' in a or 'please wait' in a or 'please wait flux' in a or 'wait please flux' in a:
        ...
        elif 'flux' in a or 'where are you flux' in a:
        ...
        elif 'record flux' in a or 'flux record' in a or 'open recorder' in a or 'show recorder' in a:
        ...
        elif 'open video player' in a or 'open flux video player' in a or 'show video player' in a or 'show flux video player' in a:
            speak("Opening flux  video player")
        ...
        #     print("")
                ...
                for url in a(a, tld="co.in", num=1, stop = 1, pause = 2):
